...
public interface AuthMapper {
    ...
    // 权限查询 (RBAC)
    java.util.List<String> findPermissionsByRole(@Param("role") String role);
    java.util.List<Map<String,Object>> findAllPermissions();
    Map<String,Object> findAdminById(@Param("id") Long id);
}
