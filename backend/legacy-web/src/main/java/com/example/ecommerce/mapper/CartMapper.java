...
public interface CartMapper {
    int upsert(@Param("userId") Long userId, @Param("productId") Long productId, @Param("skuId") Long skuId, @Param("specText") String specText, @Param("quantity") Integer quantity);
