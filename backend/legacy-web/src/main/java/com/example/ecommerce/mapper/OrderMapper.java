...
public interface OrderMapper {
    ...
    // Scheduler: find orders unpaid for more than N minutes
    List<OrderView> findExpiredUnpaid(@Param("minutes") int minutes);
    List<java.util.Map<String,Object>> findOrderItems(Long orderId);
}
