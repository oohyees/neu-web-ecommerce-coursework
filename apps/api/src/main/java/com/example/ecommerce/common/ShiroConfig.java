...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        chains.put("/api/products/admin/**", "authc");
        chains.put("/api/products", "anon");
        chains.put("/api/products/*", "anon");
        chains.put("/api/categories", "anon");
        chains.put("/api/home/banners", "authc");
        chains.put("/api/home/banners/**", "authc");
        chains.put("/api/home/**", "anon");
        chains.put("/api/announcements", "anon");
        chains.put("/api/activity-notices", "anon");
        chains.put("/api/marketing/admin/**", "authc");
        chains.put("/api/marketing/specs/*", "anon");
        chains.put("/api/marketing/coupons", "anon");
        chains.put("/api/marketing/promotions", "anon");
        chains.put("/api/reviews/admin/**", "authc");
        chains.put("/api/reviews", "authc");
        chains.put("/api/admin/**", "authc");
        chains.put("/api/auth/admin/**", "authc");
        chains.put("/api/files/upload", "authc");
